...
export default function LeadershipSection() {
  ...
  const leaders = [
    ...
    },
    {
      ...
      bio: 'K K Lakshmi serves as Customer Service Manager at ContentCraft Infotech, leading client communication and service delivery with a strong focus on responsiveness, accuracy, and quality.\n\nShe coordinates closely with institutions, publishers, and internal teams to ensure smooth execution across publishing assignments, timely updates, and consistent stakeholder alignment.\n\nWith a process-driven and client-centric approach, Lakshmi helps strengthen long-term relationships through dependable support and proactive issue resolution.',
    },
    {
