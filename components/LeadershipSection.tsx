...
export default function LeadershipSection() {
  ...
  const leaders = [
    ...
    },
    {
      ...
      image: '/employees/laxshmi.jpeg',
      linkedIn: 'https://www.linkedin.com/in/kklakshmi/',
      bio: 'With over 25 years of expertise in customer relations in the publishing industry, K K Lakshmi brings a wealth of experience to ContentCraft Infotech Pvt. Ltd.\n\nPreviously, Lakshmi excelled as a Customer Relations Manager at a leading liaisoning firm, where she played a pivotal role in representing the company at prestigious international book fairs in Germany, London, and Sri Lanka. This global exposure enriched her industry perspective and honed her skills in customer service and channel management.\n\nIn addition to her role at the liaisoning firm, she served as an Assistant Manager at Springer Nature Group, where she was instrumental in coordinating licensing agreements, further demonstrating her commitment to advancing customer service, sales support, and development.\n\nAs the Customer Service Manager at ContentCraft Infotech Pvt. Ltd., she is dedicated to delivering exceptional service and continuously enhancing customer experiences, ensuring that our clients receive the highest level of support and satisfaction.',
    },
    {
      name: 'Siddhartha Padmapati',
      role: 'Business Head',
      linkedIn: 'https://www.linkedin.com/in/siddharthapadmapati/',
